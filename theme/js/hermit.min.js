...
"mouseup";k.url=hermit.url;k.debugMode=!1;k.preferFlash=5<n?!0:!1;a.init=function(){this.fn.getjson()};a.fn={handleHash:{},bind:f.addEventListener?function(b,c,d){c.addEventListener(b,function(){d.apply(this,arguments);a.fn.handleHash[b]=a.fn.handleHash[b]||[];a.fn.handleHash[b].push(arguments.callee)},!1)}:f.attachEvent?function(b,c,d){c.attachEvent("on"+b,function(){d.apply(this,arguments);a.fn.handleHash[b]=a.fn.handleHash[b]||[];a.fn.handleHash[b].push(arguments.callee)})}:void 0,unbind:f.removeEventListener?
function(b,c){if(a.fn.handleHash[b]){var d=0,e=a.fn.handleHash[b].length;for(d;e>d;d+=1)c.removeEventListener(b,a.fn.handleHash[b][d],!1)}}:f.detachEvent?function(b,c){if(a.fn.handleHash[b]){var d=0,e=a.fn.handleHash[b].length;for(d;e>d;d+=1)c.detachEvent("on"+b,a.fn.handleHash[b][d])}}:void 0,rclass:/[\n\t]/g,rspaces:/\s+/,arraify:function(b){var a=[];try{a=Array.prototype.slice.call(b,0)}catch(d){for(var e,a=[],m=0;e=b[m++];)a.push(e)}return a},hasClass:function(b,c){return 0<=(" "+b.className+
" ").replace(a.fn.rclass," ").indexOf(" "+c+" ")?!0:!1},addClass:function(b,c){if(c&&"string"==typeof c){var d=(c||"").split(a.fn.rspaces);if(1===b.nodeType)if(b.className){for(var e=" "+b.className+" ",m=b.className,f=0,g=d.length;g>f;f++)0>e.indexOf(" "+d[f]+" ")&&(m+=" "+d[f]);b.className=a.fn.trim(m)}else b.className=c}},removeClass:function(b,c){if(c&&"string"==typeof c||void 0===c){var d=(c||"").split(a.fn.rspaces);if(1===b.nodeType&&b.className)if(c){for(var e=(" "+b.className+" ").replace(a.fn.rclass,
" "),f=0,g=d.length;g>f;f++)e=e.replace(" "+d[f]+" "," ");b.className=a.fn.trim(e)}else b.className=""}},getById:function(b){return f.getElementById(b)},getByTagName:function(b,c){return c=c||f,a.fn.arraify(c.getElementsByTagName(b))},getByClassName:function(b,c,d){if(c=c||f,c.getElementsByClassName)return a.fn.arraify(c.getElementsByClassName(b));for(var b=b.replace(/\-/g,"\\-"),e=[],c=a.fn.getByTagName(d||"*",c),d=c.length,b=RegExp("(^|\\s)"+b+"(\\s|$)");d--;)b.test(c[d].className)&&e.push(c[d]);
return e.reverse(),e},each:function(b,a){if(t!=b.length)for(var d=0,e=b.length;e>d&&!1!==a.call(b[d],d,b[d]);d++);else for(name in b)a.call(b[name],name,b[name])},index:function(a,c){var d,e=c.length;for(d=0;e>d;d++)if(a==c[d])return d;return-1},trim:function(a){return a.replace(/^(\s|\u00A0)+/,"").replace(/(\s|\u00A0)+$/,"")},getjson:function(){a.fn.each(a.fn.getByClassName("hermit"),function(b){var c=this,d=c.getAttribute("songs").split("#:");a.fn.ajaxp({url:"http://goxiami.duapp.com/",param:{type:d[0],
id:d[1]},after:function(d){a.fn.createPlayListUI.call(c,d,b)}})})},create:function(b){var c=this;i=null!=b?b:0;g=null!=g?g:0;a.sound&&(a.sound.destruct(),g==h[i].length&&(g=0));k.onready(function(){a.sound=k.createSound({id:"goXiami",url:h[i][g].src,volume:80,autoLoad:!1,onload:function(){3>this.readyState&&(a.fn.getByClassName("hermit-detail",c,"div")[0].innerHTML="\u97f3\u4e50\u64ad\u653e\u5668\u521d\u59cb\u5316\u5931\u8d25!")},whileloading:function(){a.fn.getByClassName("hermit-loaded",c,"div")[0].style.width=
100*(this.bytesLoaded/this.bytesTotal)+"%"},whileplaying:function(){var b=a.fn.getByClassName("hermit-duration",c,"div")[0],e=a.fn.getByClassName("hermit-prosess-bar",c,"div")[0],f=100*(this.position/this.duration)+"%",g=a.fn.parseTime(this.position/1E3)+"/"+a.fn.parseTime(this.duration/1E3);!a.moving&&(e.style.width=f);b.innerHTML=g},onplay:function(){var b=a.fn.getByClassName("hermit-song",c,"div"),e=a.fn.getByClassName("hermit-detail",c,"div")[0];a.fn.each(b,function(){a.fn.removeClass(this,"selected")});
a.fn.addClass(b[g],"selected");e.innerHTML=a.fn._expect(b[g].innerHTML,0,40,"...")+"  ("+(g+1)+"/"+h[i].length+")"},onpause:function(){},onfinish:function(){if(g++,a.sound.resume(),g<h[i].length)a.fn.create.call(c,i);else{var b=a.fn.getByClassName("hermit-prosess-bar",c,"div")[0],e=a.fn.getByClassName("hermit-button",c,"div")[0],f=a.fn.getByClassName("hermit-duration",c,"div")[0],j=a.fn.getByClassName("hermit-song",c,"div");a.fn.each(j,function(){a.fn.removeClass(this,"selected")});b.style.width=
0;i=g=null;a.sound=null;f.innerHTML="";a.fn.removeClass(e,"playing")}}});a.sound.play()})},createPlayListUI:function(b,c){var d=a.fn.getByClassName("hermit-list",this,"div")[0],e="";if(h[c]=[],b.album_id||b.collect_id)b=b.songs,a.fn.each(b,function(){null!=this&&(h[c].push({src:this.song_src}),e+='<div class="hermit-song">'+this.song_title+" - "+this.song_author+"</div>")});else{var f=this.getAttribute("songs").split("#:")[1],f=f.split(",");a.fn.each(f,function(){null!=b[this]&&(h[c].push({src:b[this].song_src}),
e+='<div class="hermit-song">'+b[this].song_title+" - "+b[this].song_author+"</div>")})}d.innerHTML=e;a.fn.playEvent.call(this)},playEvent:function(){var b=this,c=a.fn.getByClassName("hermit-button",b,"div")[0],d=a.fn.getByClassName("hermit-listbutton",b,"div")[0],e=a.fn.getByClassName("hermit-list",b,"div")[0],f=a.fn.getByClassName("hermit-song",e,"div"),j=(parseInt(a.fn._getStyle(f[0],"height"))+1)*f.length,h=a.fn.getByClassName("hermit-prosess",b,"div")[0],k=a.fn.getByClassName("hermit-prosess-after",
h,"div")[0],j=360>=j?j:360,j=j+"px";e.style.height=j;a.fn.each(f,function(){var d=a.fn.index(b,a.fn.getByClassName("hermit"));this.onclick=function(){var e=a.fn.index(this,f);if(i==d)e==g?c.click():(g=e,a.fn.create.call(b,d));else{if(a.sound){var h=a.fn.getByClassName("hermit")[i],j=a.fn.getByClassName("hermit-button",h,"div")[0],h=a.fn.getByClassName("hermit-song",h,"div")[g];a.fn.removeClass(j,"playing");a.fn.removeClass(h,"selected");a.sound.resume()}g=e;a.fn.addClass(c,"playing");a.fn.create.call(b,
d)}}});a.fn.bind(s,c,function(){var d=a.fn.index(b,a.fn.getByClassName("hermit"));if(a.fn.hasClass(c,"playing"))a.fn.removeClass(c,"playing"),a.sound.pause();else if(a.fn.addClass(c,"playing"),a.sound&&i==d)a.sound.play();else{if(a.sound){var e=a.fn.getByClassName("hermit")[i],f=a.fn.getByClassName("hermit-button",e,"div")[0],e=a.fn.getByClassName("hermit-song",e,"div")[g];g=null;a.fn.removeClass(f,"playing");a.fn.removeClass(e,"selected")}a.fn.create.call(b,d)}});a.fn.bind(s,d,function(){a.fn.hasClass(b,
"unexpand")?(a.fn.removeClass(b,"unexpand"),e.style.height=j):(a.fn.addClass(b,"unexpand"),e.style.height=0)});a.fn.bind(s,h,function(b){if(a.sound){var c=parseInt(a.fn._getStyle(h,"width")),d=a.fn._offset(h).left,b=a.fn._pageEvent(b).pageX-d,b=b/c*a.sound.duration;a.sound.setPosition(b)}});a.fn.bind(w,k,a.fn._bind(a.fn._start,b))},_pageEvent:function(b){if(b=b||o.event,l&&b.touches.length)b.pageX=b.touches.item(0).pageX,b.pageY=b.touches.item(0).pageY;else if("undefined"==typeof b.pageX){var a=f.documentElement,
d=f.body;b.pageX=b.clientX+(a&&a.scrollLeft||d&&d.scrollLeft||0)-(a&&a.clientLeft||d&&d.clientLeft||0);b.pageY=b.clientY+(a&&a.scrollTop||d&&d.scrollTop||0)-(a&&a.clientTop||d&&d.clientTop||0)}return b},_expect:function(a,c,d,e){return e=a.length>d-c?e:"",a=a.slice(c,d),a+e},_offset:function(a){var c=a.getBoundingClientRect(),d=a.ownerDocument,a=d.body,d=d.documentElement;return{top:c.top+(self.pageYOffset||d.scrollTop||a.scrollTop)-(d.clientTop||a.clientTop||0),left:c.left+(self.pageXOffset||d.scrollLeft||
a.scrollLeft)-(d.clientLeft||a.clientLeft||0)}},_getStyle:function(a,c){return 5<n&&9>n?(c=c.replace(/^(\w)/g,function(a,b){return b.toUpperCase()}),a["client"+c]):f.defaultView.getComputedStyle(a,null).getPropertyValue(c)},_bind:function(a,c){return function(){return a.apply(c,arguments)}},_start:function(){a.moving=!0;a.fn.bind(u,f,a.fn._bind(a.fn._move,this));a.fn.bind(v,f,a.fn._bind(a.fn._end,this));a.fn.bind("touchcancel",f,a.fn._bind(a.fn._end,this))},_move:function(b){event=a.fn._pageEvent(b);
var c=a.fn.getByClassName("hermit-prosess",this,"div")[0],b=a.fn.getByClassName("hermit-prosess-bar",c,"div")[0],d=parseInt(a.fn._getStyle(c,"width")),c=a.fn._offset(c).left,c=event.pageX-c,d=c/d;b.style.width=100*(1<d?1:d)+"%"},_end:function(){a.fn.getByClassName("hermit-prosess-after",this,"div")[0];if(a.sound){var b=a.fn.getByClassName("hermit-prosess",this,"div")[0],c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],b=parseInt(a.fn._getStyle(b,"width")),c=parseInt(a.fn._getStyle(c,"width")),
c=c/b,c=(1<c?1:c)*a.sound.duration;a.sound.setPosition(c)}a.fn.unbind(u,f);a.fn.unbind(v,f);a.fn.unbind("touchcancel",f);try{delete a.moving}catch(d){a.moving=t}a.fn.handleHash={}},ajaxp:function(b){setTimeout(function(){var c=(new Date).valueOf(),d=f.createElement("script");body=f.documentElement;head=body.getElementsByTagName("head")[0];callbackName="hermit"+parseInt(999999*Math.random());b.param.callback=callbackName;b.param._=c;o[callbackName]=function(a){b.after.call(this,a);head.removeChild(d)};
d.src=b.url+"?"+a.fn.serialize(b.param);head.appendChild(d)},0)},_loadScript:function(b,c){setTimeout(function(){var d=f.createElement("script");d.src=b;d.readyState?a.fn.bind("readystatechange",d,function(){("loaded"===d.readyState||"complete"===d.readyState)&&(c&&c(),a.fn.unbind("readystatechange",d))}):a.fn.bind("load",d,function(){c&&c();a.fn.unbind("load",d)});f.getElementsByTagName("head")[0].appendChild(d)},0)},serialize:function(a){var c=[];for(key in a)key=[key,a[key]].join("="),c.push(key);
return c.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var c=Math.floor(a/60),a=Math.floor(a)%60;return(10>c?"0"+c:c)+":"+(10>a?"0"+a:a)}};a.init()})(window,document);